...
export class ListComponent implements OnInit {
  ...
  customerActionFormatter(): any {
    return this.sanitizer.bypassSecurityTrustHtml(
      ` <div class="btn-group dropdown" ngbDropdown>
       <a href="javascript: void(0);" ngbDropdownToggle class="table-action-btn arrow-none btn btn-light btn-sm" ><i class="mdi mdi-dots-horizontal"></i></a>
       <div class="dropdown-menu dropdown-menu-end" ngbDropdownMenu>
        <a class="dropdown-item" href="javascript:void(0)" ngbDropdownItem><i class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i>Edit Ticket</a>
        <a class="dropdown-item" href="javascript:void(0)" ngbDropdownItem><i class="mdi mdi-check-all me-2 text-muted font-18 vertical-middle"></i>Close</a>
        <a class="dropdown-item" href="javascript:void(0)" ngbDropdownItem><i class="mdi mdi-delete me-2 text-muted font-18 vertical-middle"></i>Remove</a>
        <a class="dropdown-item" href="javascript:void(0)" ngbDropdownItem><i class="mdi mdi-star me-2 font-18 text-muted vertical-middle"></i>Mark as Unread</a>
        </div>
        </div>`
    );
  }
  ...
  searchData(searchTerm: string): void {
    if (searchTerm === "") {
      ...
      //  filter
      updatedData = updatedData.filter((ticket) =>
        this.matches(ticket, searchTerm)
      );
