...
const TWO_COl_MENU_ITEMS: MenuItem[] = [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            link: "/apps/email/email-templates",
            parentKey: "apps-email",
          },
        ],
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        key: "auth-reset-password2",
        label: "Recover Password 2",
        link: "/auth/reset-password2",
        parentKey: "auth-pages",
      },
      {
        key: "auth-gallery",
      ...
      },
      {
        ...
        label: "Lock Screen 2",
        link: "/auth/lock-screen2",
        parentKey: "auth-pages",
      },
      {
        key: "auth-error-404-two",
        label: "Logout",
        link: "/auth/logout2",
        parentKey: "auth-pages",
      },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            key: "icon-material-symbols",
            label: "Material Symbols Icons",
            link: "/icons/material-symbols",
            parentKey: "icons",
          },
          {
            key: "icon-two-tone",
