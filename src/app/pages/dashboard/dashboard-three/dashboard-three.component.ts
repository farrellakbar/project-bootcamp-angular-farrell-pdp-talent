...
export class DashboardThreeComponent implements OnInit {
  ...
  revenueChartOptions!: ChartjsOptions<"line">;
  // revenueChartColors: Color[] = [];

  performanceChartOptions!: ChartjsOptions<"bar">;
  ...
  ngOnInit(): void {
    ...
    this.pageTitle = [
      ...
      { label: "Dashboard 3", path: "/", active: true },
    ];
  ...
  archiveTodos(): void {
    this.todoList = this.todoList.filter(
      (todoItem: ToDoItem) => todoItem.completed === false
    );
  }
}
